...
export function validateGovernanceIntegrity(g = loadGovernance()) {
  ...
  assert(loop.visibility_rule?.includes('التفكير الداخلي الخام'), 'WAW-LIMA-HAYYA raw-reasoning visibility boundary missing');
  ...
  assert(evolutionRuntime.includes("candidate.waw_lima_hayya_completed !== true"), 'self-evolution runtime WAW-LIMA-HAYYA promotion binding missing');
