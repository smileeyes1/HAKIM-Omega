...
assert.equal(mission.mission_id,'IDLE');
...
console.log(JSON.stringify({pass:true,assertions:26,metadata_hosts:metas.length,policy_hosts:policy.allowed_hosts.length,remote_mission_default:'IDLE_FAIL_SAFE'},null,2));
