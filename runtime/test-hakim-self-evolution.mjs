...
assert(evaluateCandidate({ ...good, material_nontrivial: true, innovation_search_completed: true }).decision === 'PROMOTE_CANDIDATE', 'wise innovated material candidate rejected');
