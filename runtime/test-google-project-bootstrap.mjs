...
ctx.lineage={omega_lineage_version:'1',artifact_id:'A',artifact_sha256:null,native_identity:{mimeType:'application/vnd.google-apps.document'},native_google_identity:null,dna:{genome_id:'OMEGA_INHERITABLE_ASSURANCE_DNA',genome_version:'1.1.0',genome_sha256:'aedbec1d0adb29863436283534e2cba7d581d6fc04ba431ea21690a888f0e70d'},parent:{id:'P'},evidence_refs:['E'],gate:{result:'PASS',scope:'HOST_ONLY',tested_equals_delivered:true},claims:[]};
